function SpecialOnEdit(e) { // wrapping it within an onEdit(e) function
  ...
  if (
    e.source.getSheetName() == FOLHA_ALUNOS && //folha tester coluna Q
    ...
    e.source.getSheetName() == FOLHA_ALUNOS && //folha tester coluna R
  ...
  } else if (e.source.getSheetName() == FOLHA_ALUNOS && //folha tester coluna S
